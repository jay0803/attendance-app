...
VALUES 
    ('user1', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 
     '홍길동', '010-1111-1111', 'hong@example.com', 'USER', true, NOW(), NOW()),
    ('user2', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 
     '김철수', '010-2222-2222', 'kim@example.com', 'USER', true, NOW(), NOW()),
    ('user3', '$2a$10$N9qo8uLOickgx2ZMRZoMyeIjZAgcfl7p92ldGxad68LJZdL17lhWy', 
     '이영희', '010-3333-3333', 'lee@example.com', 'USER', true, NOW(), NOW());

-- 예배 일정 (날짜는 실제 사용 시 수정 필요)
INSERT INTO services (name, service_time, type, active, created_at, updated_at)
VALUES 
    ('주일 1부 예배', '2025-11-23 09:00:00', 'SUNDAY', true, NOW(), NOW()),
    ('주일 2부 예배', '2025-11-23 11:00:00', 'SUNDAY', true, NOW(), NOW()),
    ('수요 예배', '2025-11-19 19:30:00', 'WEDNESDAY', true, NOW(), NOW()),
    ('금요 기도회', '2025-11-21 19:30:00', 'FRIDAY', true, NOW(), NOW());
